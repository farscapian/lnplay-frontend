<script lang="ts">
  ...
  async function createOrder() {
    const { node_count, hours, seconds } = order
    const response = (await request(
      'lnplaylive-createorder',
      `{ "node_count": ${node_count}, "hours": ${hours}, "seconds": ${seconds} }`
  ...
  <section class="w-full mt-20 text-center p-5 pt-10 pb-10 m-auto rounded bg-[#FEDD2B]/40">
    ...
    <div class="mt-8 flex-wrap md:flex gap-5 justify-center items-center">
      ...
      <div class="mt-5 md:mt-0">
        ...
        <p
          style="font-family: 'Courier New', Courier, monospace; font-weight: 700; font-size: 41px; line-height: 45px; color: #000000;"
        >
          {order.hours} HOURS
        </p>
        <input
    ...
    <!--Added colaspiable panel below-->
    <button class="accordion"><u>Customize</u></button>
    <div class="panel">
      <table>
        <tr>
          <td>Plugin</td>
          <td>
            <select class="styled-select">
              ...
              <option value="clboss">CLBoss</option>
            </select>
          </td>
        </tr>
        <td>Block Time</td>
        <td>
          <p style="font-family: 'Courier New', Courier, monospace; font-weight: bold; font-size: 18px; line-height: 22px; color: #000000;">
        ...
        >
        <tr>
          <td style="width:30%;">Referral Code</td>
          <td style="width:58%;"
            ><input
              type="text"
              style="border: 1px solid black; border-radius: 4px; text-indent: 2px; width: 55%"
